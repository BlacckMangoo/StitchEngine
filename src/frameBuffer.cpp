...
void FrameBuffer::AddColorAttachment(const unsigned int textureId) {
...
void FrameBuffer::AddDepthAttachmentRenderBuffer(unsigned int renderBufferId) const {
    glNamedFramebufferRenderbuffer(frameBufferObject,
                                   GL_DEPTH_ATTACHMENT,
                                   GL_RENDERBUFFER,
                                   renderBufferId);
}

void FrameBuffer::AddDepthAttachmentTexture(const unsigned int textureId) const {
    glNamedFramebufferTexture(frameBufferObject, GL_DEPTH_ATTACHMENT, textureId, 0);
}

void FrameBuffer::FinalizeColorAttachments() const {
